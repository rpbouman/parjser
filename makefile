...
parjser.zip: license/license.txt license/lgpl-3.0.txt examples/example-utils.js examples/ParjserPlayground.html js/parjser-min.js js/parjser.grammars-min.js js/parjser.TopDownParser.js js/parjser.TopDownParserWithLookahead.js js/parjser.TopDownParser-min.js js/parjser.TopDownParserWithLookahead-min.js 
	zip parjser.zip source/* js/* examples/* lib/* license/*
